...
const Banner = ({language}:any) => {
  return (
    <div className='hidden h-20 md:flex items-center justify-center gap-10'>
        ...
        <Link href='https://www.marketwatch.com/press-release/proprhome-launches-partnership-with-metaverse-company-to-offer-digital-twin-real-estate-viewings-2023-04-21?mod=search_headline' className="bg-marketwatch bg-no-repeat bg-center bg-contain h-12 w-44 mb-1"></Link>
    </div>
  )
}
